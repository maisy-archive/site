...
export default ({ children, className, path, name, description, date, tags }: ArticleCardProps) => {
    return (
        <a href={path} className={`mt-5 p-5 <lg:mx-auto w-full h-auto transition-all bg-light-tertiary shadow shadow-light-quarternary break-words dark:(bg-dark-secondary shadow-dark-secondary)${className ? " " + className : ""}`}>
